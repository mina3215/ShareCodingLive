...
public class ConferenceController {
    ...
    @PostMapping("/create")
    public ResponseEntity<String> create(@RequestHeader("Authorization") String accessToken, @RequestBody ConferenceCreateReqDto conferenceCreateReqDto){ //title과 시작 시간 입력받음
        // 서비스에서 방 생성 로직 처리
        // 결과로 방 링크 반환
        String link = "";
    ...
    @GetMapping("/start")
    public ResponseEntity<String> start(@RequestHeader("Authorization") String accessToken, @RequestParam String link){
    ...
    public ResponseEntity<String> join(@RequestHeader("Authorization") String accessToken, @RequestParam String link){
    ...
    @GetMapping("/end")
    public ResponseEntity<String> end(@RequestHeader("Authorization") String accessToken, @RequestParam String uuid){
